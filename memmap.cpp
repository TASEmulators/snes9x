...
{
	IPPU.TileCache[TILE_2BIT]       = alloc_invisible<uint8>(MAX_2BIT_TILES * 64);
	IPPU.TileCache[TILE_4BIT]       = alloc_invisible<uint8>(MAX_4BIT_TILES * 64);
	IPPU.TileCache[TILE_8BIT]       = alloc_invisible<uint8>(MAX_8BIT_TILES * 64);
	IPPU.TileCache[TILE_2BIT_EVEN]  = alloc_invisible<uint8>(MAX_2BIT_TILES * 64);
	IPPU.TileCache[TILE_2BIT_ODD]   = alloc_invisible<uint8>(MAX_2BIT_TILES * 64);
	IPPU.TileCache[TILE_4BIT_EVEN]  = alloc_invisible<uint8>(MAX_4BIT_TILES * 64);
	IPPU.TileCache[TILE_4BIT_ODD]   = alloc_invisible<uint8>(MAX_4BIT_TILES * 64);

	IPPU.TileCached[TILE_2BIT]      = alloc_invisible<uint8>(MAX_2BIT_TILES);
	IPPU.TileCached[TILE_4BIT]      = alloc_invisible<uint8>(MAX_4BIT_TILES);
	IPPU.TileCached[TILE_8BIT]      = alloc_invisible<uint8>(MAX_8BIT_TILES);
	IPPU.TileCached[TILE_2BIT_EVEN] = alloc_invisible<uint8>(MAX_2BIT_TILES);
	IPPU.TileCached[TILE_2BIT_ODD]  = alloc_invisible<uint8>(MAX_2BIT_TILES);
	IPPU.TileCached[TILE_4BIT_EVEN] = alloc_invisible<uint8>(MAX_4BIT_TILES);
	IPPU.TileCached[TILE_4BIT_ODD]  = alloc_invisible<uint8>(MAX_4BIT_TILES);
